...
export const useContextMenu = (): UseContextMenu => {
  ...
  const handleContextMenu = useCallback((event: React.MouseEvent | React.TouchEvent, selection?: selectionInfo, tab?: string) => {
  ...
  const handleTabContextMenu = useCallback((event: React.MouseEvent | React.TouchEvent, tab: string) => {
